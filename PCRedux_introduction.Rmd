---
title: "PCRedux package - an introduction"
...
analytical description are discussed (\autoref{section_analysis_functions}) more 
...
assumption is not valid. In chapters \autoref{section_software} and 
\autoref{htPCR_nap_frequency} it was described that a considerable proportion of 
...
```{r plot_FFTrees, eval=TRUE, echo=FALSE, fig.cap=plot_FFTrees, fig.scap=plot_FFTrees_short, fig.height=11, fig.width=11}
...
attempts to make use of characteristics of the amplification curve. Positive 
...
supplement](https://github.com/devSJR/PCRedux/raw/master/docs/articles/PCRedux.pdf)**, further reasons were elaborated on why statistical methods are necessary 
...
Although data sets in the \texttt{PCRedux} package are large compared to what 
has been previously available, there is no conclusive evidence of how well these 
